...
public class LanguageRecord extends UpdatableRecordImpl<LanguageRecord> implements Record3<Integer, String, String> {
    ...
    private static final long serialVersionUID = 33517845;

    /**
     * Setter for <code>jooq_demo.language.id</code>.
     */
    ...
    /**
     * Getter for <code>jooq_demo.language.id</code>.
     */
    ...
    /**
     * Setter for <code>jooq_demo.language.cd</code>.
     */
    ...
    /**
     * Getter for <code>jooq_demo.language.cd</code>.
     */
    public String getCd() {
        return (String) get(1);
    }
    ...
    /**
     * Setter for <code>jooq_demo.language.description</code>.
     */
    ...
    /**
     * Getter for <code>jooq_demo.language.description</code>.
     */
